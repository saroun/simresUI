...
/**
 * Rùzné pomocné metody: pro pøevod èísel z/do "String", pro naèítání èísel
 * z "JTextFiels", pro práci s jmény souborù, pro formátování výpisù z debugování 
 *
 *
...
public class Utils {
	...
	/*
	 * Na rozdíl od metody Integer.parseDouble(String s), která se umí vypoøádat
	 * i s mezerami pøed èíslem, je metoda Integer.parseInt(String s) striktnì
	 * omezena pouze znaky '0'--'9', které jsou eventuálnì pøedcházeny znakem '-'.
	 * Abych docílil podobného (a žádaného chování) jako parseDouble, musím
	 * sám dìlat String.trim()
	 */
