...
import cz.saroun.classes.editors.propertiesView.PropertiesView;
 ...
 */
abstract public class IPropertiesDialogOld extends InternalDialog {
	...
	//                                 CONSTRUCTORS                                         //
	//////////////////////////////////////////////////////////////////////////////////////////
	public IPropertiesDialogOld(Point origin, CommandGuiExecutor executor, boolean showUnits, JDesktopPane desktop) {
		super(desktop);		
	...
	/**
	 * Call just after constructor - it actually creates content pane<br/>
	 * 
	 */
	public void InitProperties() {
		propertiesView=null;
		pnlContentPane=null;
		//ImageIcon ico = executor.getClassIcon(this);
		//if (ico!=null) setFrameIcon(ico);
		setContentPane(getPnlContentPane());
		pack();
	}
	...
	private JPanel getPnlContentPane() {
		...
		// label bar	
			...
			pnlContentPane.add(getPnlLabel(), c);
		// properties table
			c.gridx = 0;
			c.gridy = 1;
			c.weightx = 1.0;
			...
			pnlContentPane.add(getPropertiesView(), c);
		// buttons bar
			c.gridx = 0;
			c.gridy = 2;
			c.weightx = 1.0;
	...
	protected JPanel createPnlButtons() {
			JPanel pnl = new JPanel();
			pnl.setLayout(new GridBagLayout());			
			createCmdButtons(pnl,getButtonNames());			
		return pnl;
	}
	 ...
	 * Overloaded method for non=standard button size
	 */
...
--------------------------------------------------*/
	...
	/**
	 * Handles actions: Cancel, Close, Help + those handled by
	...
	public void showDialog() {
		if (! isVisible()) updatePropertyEditors();
		super.showDialog();
	}
