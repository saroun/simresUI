 ...
 * Tento panel je pak zobrazen v z�lo�ce "Fit" ��d�c�ho okna
 * "ControWindow".
 *
 *
...
public class PanelFit extends JPanel {
	...
	//////////////////////////////////////////////////////////////////////////////////////////
	/*
	 * n�sleduj�c� funk�n� signatura:
	 *     public void handleIteration(int nit, double lambda, double meanChisqr, Vector<Double> chisqr) {
	 * byla zam��lena pro p��pad, kdyby se individu�ln� chisqr
	 * pro ka�d� dataset vypisoval v panelu FIT. Te� se v�ak vypisuje v konzolov�m oknu,
	 * co� obstar�v� XML handler
	 */
		...
		if (btnFitOmexc == null) {
			...
			btnFitOmexc.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					/*
					 * Zjisti zda je n�kter� z pol� H, K, L a En pr�zdn�:
					 * Pokud ano vy�li jen p��kaz OMEXC
					 * Pokud ne vy�li p��kaz ve form�tu OMEXC H K L En
					 * 
	...
	private JButton getBtnFitPlot() {
		if (btnFitPlot == null) {
			...
			btnFitPlot.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					/*
					 * I kdy� je to p��kaz pro kreslen�, chov� se jinak, kdy� se vol� z podmenu FIT
					 * Nav�c u tohoto p��kazu z�le�� na tom jestli se vol� jako MFIT �i FIT
					 */
					String cmd="";
	...
	*****************************************************************************************/
	private JTable getTblFitParameters() {
		if (tblFitParameters == null) {
			...
			tblFitParameters.setAutoResizeMode(JTable.AUTO_RESIZE_LAST_COLUMN);  // kdy� u�, tak m�� velikost pouze u sloupce "value"
	...
	/*
	 * N�sleduj�c� tabulka je pouze "zrcadlem" tabulky restraxu. Viz. "PanelData" a tamn�
	 * "DataNameList". 
	 */
	public class FitParameters extends AbstractTableModel {
		...
		public void addRow(boolean fit, String parameter, double value) {
			...
			int addedRowNum = this.parameter.size()-1; // p�idan� ��dka je um�st�na na konci
		...
		public boolean isCellEditable(int row, int col) {
			...
			if (col == 1) {  // "parameters" sloupec nen� mo�n� m�nit
				return false;
			} else {         // av�ak sloupce "fit" a "value" je mo�n� m�nit/p�ep�nat
				return true;
			}
		}
		...
		public void setValueAt(Object value, int row, int col) {
			...
			switch (col) {
				case 0:
					...
					break;
				// case 1:
					// Pozn�mka: Druh� sloupe�ek tabulky nen� editovateln�
				case 2:
