...
public class ControlWindow extends JInternalFrame {
	...
	private void switchButton(JToggleButton source) {
		if (source.isSelected()) {  // zm��klo se tla��tko? (ve chvili kdy se vol� "actionPerformed()" je u� stav zm�n�n)
			...
			if (unselect != null) {
				...
				// okno bylo minimalizov�no (byly kresleny jen tla��tka),
                // te� se odminimalizov�v� --- vykresli vertik�ln� odd�lova�
			...
			// tla��tko bylo odzna�eno
			if (source == selected) { // zdrojem odzna�en� je toto tla��tko
				minimalize();
			}
			// else --- zdrojem odzna�en� bylo jin� tla��tko, kter� bylo
			// zm��knuto --- ned�lej nic (toto tla��tko bylo ji� odzna�eno, proto
			// se (necht�n�) zavolal tento Listener)
		}
	}
	...
	private void initialize() {
		...
		/* 
		 * n�sleduj�c� parametry bych mohl nastavit i "ru�n�", nebo� je zn�m
		 * (viz. ��dky) v��e. Nicm�n� kdyby se upravoval design Visual editorem,
		 * mohlo by doj�t k chyb�, proto�e tyto n�sleduj�c� parametry by nebyly
		 * upraveny
		 */
